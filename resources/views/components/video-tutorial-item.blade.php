<div class="w-full md:w-1/2 xl:w-1/3 px-4">
    <div class="bg-white rounded-lg mb-10">
        ...
        <div class="p-6 xl:p-7 2xl:p-9 h-[320px] overflow-hidden text-center">
            <h3><a href="https://youtu.be/{{ $videoId }}" target="_blank"
                   class="font-bold text-dark text-lg mb-4 block hover:text-primary">{{ $title }}</a></h3>
            <p class="text-base text-body-color leading-relaxed mb-7">{{ $description }}</p>
        </div>
        <!-- ====== Video Content End -->
    </div>
</div>
