            ...
            <div class="w-full lg:w-1/2 xl:w-5/12 px-4">
                <div class="bg-white relative rounded-lg p-8 sm:p-12 shadow-lg">
                    <form action="/contact/submit" method="POST" x-data="{
                        ...
                        @csrf
                        <div class="mb-6">
                            <x-forms.input placeholder="Name" name="name" x-model="formData.name"></x-forms.input>
                        </div>
                        <div class="mb-6">
                            <x-forms.input placeholder="Email" name="email" x-model="formData.email"></x-forms.input>
                        </div>
                        <div class="mb-6">
                            <x-forms.textarea placeholder="Message" name="message" rows="6" x-model="formData.message"></x-forms.textarea>
                        </div>
                        <div>
